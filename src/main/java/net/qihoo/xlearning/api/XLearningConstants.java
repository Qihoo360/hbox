...
public interface XLearningConstants {
  ...
  enum Environment {
    ...
    XLEARNING_APP_NAME("XLEARNING_APP_NAME"),
    ...
    XLEARNING_DMLC_WORKER_NUM("DMLC_NUM_WORKER"),

    XLEARNING_DMLC_SERVER_NUM("DMLC_NUM_SERVER"),

    XLEARNING_LIGHTGBM_WORKER_NUM("LIGHTGBM_NUM_WORKER"),

    XLEARNING_LIGHTLDA_WORKER_NUM("LIGHTLDA_NUM_WORKER"),

    XLEARNING_LIGHTLDA_PS_NUM("LIGHTLDA_NUM_PS"),
    ...
    XLEARNING_OUTPUTS_WORKER_INDEX("XLEARNING_OUTPUT_WORKER_INDEX"),
